...
const ProductCard = () => {
  ...
  return (
    <>
      ...
      >
        <Grid container spacing={isMediumScreen ?  6 : 10}>
          {/* ================LEFT */}
        ...
        >
          ...
          <Grid item lg={5} md={5} sm={12} xs={12}>
            <Box>
              ...
              <Divider sx={{background:'lightgray' , width:'100%' , height:'0.1px', }}/>

              <Box sx={{marginTop:'2rem',display:'flex', alignItems:'center',marginBottom:'2rem'}}>
                <Box sx={{display:'flex', alignItems:'center', marginRight :'3rem'}}>
                <Divider orientation="vertical" sx={{background:theme.palette.primary.main , width:'2px' , height:'50px'}}/>
              ...
              <Box sx={{display:'flex', justifyContent:"space-between", width:'100%', marginTop:'2rem',
                border:'1px solid #baccc1', borderRadius:'10px', bgcolor:'white',
                ...
                {buttonData.map((row, index)=>(
                  ...
                  sx={{
                    cursor:'pointer',
                    bgcolor:selectedIndex === index ? theme.palette.primary.main :'transparent' ,
                     p:'0.5rem',
            ...
            <Box sx={{
                ...
                <Box>
                  <IconButton sx={{fontSize:'2rem'}} onClick={()=>setOrderQuantity((pre)=>pre > 1 ? pre -1 : pre)} >
                    -
                  </IconButton>
                </Box>
                <Typography sx={{
                ...
                <Box>
                  <IconButton sx={{fontSize:'1.5rem'}} onClick={()=>setOrderQuantity((pre)=>pre+1)}>
                    +
                  </IconButton>
                </Box>
            </Box>
            ...
            <Box sx={{display:'flex', alignItems:'center', justifyContent:'center',
              bgcolor:theme.palette.primary.main,py:0.2, px:1,
              width:'100%',
            ...
            <Divider sx={{background:'lightgray' , width:'100%' , height:'0.1px', my:'2rem'}}/>


            <Box sx={{marginTop:'2rem',display:'flex', alignItems:'center',marginBottom:'2rem'}}>
                <Box sx={{display:'flex', alignItems:'center', marginRight :'3rem'}}>
                <img src="/OPvan.png" alt="" style={{width:'2.5rem'}}/>
                <Box sx={{marginLeft:'1rem'}}>
                <Typography
                  sx={{
                    color:theme.palette.primary.main,
                ...
                <Box sx={{display:'flex', alignItems:'center'}}>
               <img src="/OPfree.png" alt="" style={{width:'2.5rem'}} />
                <Box sx={{marginLeft:'1rem'}}>
                <Typography
                  sx={{
                    color:theme.palette.primary.main,
